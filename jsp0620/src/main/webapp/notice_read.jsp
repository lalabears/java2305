...
<body>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        <td><strong>날짜 </strong> <span class="separator">| </span>
        <%= board.getBdate() %></td>
      </tr>
      <tr>
        <td><strong>작성자</strong> <span class="separator">| </span>
        <%= board.getId() %></td>
      </tr>
      <tr>
        <td><strong>조회수</strong> <span class="separator">| </span>
        <%= board.getBhit() %></td>
      </tr>
      <tr>
        <td class="article">
        ...
        <td> <img alt="" src="upload/"+<%= board.getBfile() %>></td>  
      </tr>
      <tr>
